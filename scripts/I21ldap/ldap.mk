...
export ldap_server_hostname = $(call query,select hostname from hosts where is_ldap_server=1 limit 1)
...
# ldap_domain_dn
root_pw : templates/change_root_pw.ldif /usr/bin/ldapadd work/dir
...
# ldap_domain_short
# ldap_domain_dn
make_domain : templates/make_domain.ldif /usr/bin/ldapadd work/dir
...
/etc/ldap.conf : templates/ldap.conf /usr/sbin/sssd work/dir
